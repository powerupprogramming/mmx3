...
class IntroCinematic {
    ...
    execute = () => {
        ...
        // Spawn final copter
        if (Date.now() > this.startTime + 7000 && this.events.spawnedSpyCopters !== undefined && this.events.finalSpyCopter === undefined) {
            // spycopter 1 in middle 
        ...
        if (this.finalSpyCopter) {
            ...
            // Create zero
            if (this.events.zeroJumps !== undefined) {
